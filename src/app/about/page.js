      ...
      <section className={styles.pageContent}>
        <div className={styles.pageInner}>
          ...
          <div className={`${styles.directorSection} reveal`}>
            <div className={styles.directorPhoto} style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRadius: '50%', border: '8px solid var(--color-white)', boxShadow: '0 10px 30px rgba(0,0,0,0.08)' }}>
              <img 
                src={assetPath('/images/about/director.jpg')} 
                alt={about?.director?.name || 'Director'} 
                style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '50%' }}
              />
              <div style={{ position: 'absolute', bottom: '0px', right: '0px', background: 'var(--color-accent)', borderRadius: '50%', padding: '8px', display: 'flex', boxShadow: '0 4px 10px rgba(0,0,0,0.1)' }}>
